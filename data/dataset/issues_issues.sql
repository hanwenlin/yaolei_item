...
CREATE TABLE `issues_issues`  (
  ...
  `issue` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `issues_issues` VALUES (1, 'A', '装柱前混匀是会有大量浮胶出现，并且装填效果不好', '填料里含有部分碎胶未清除干净，影响柱效', '1.新旧填料都存在碎胶，以及上浮部分也存在好觉 2.对于新填料，以及旧的Mabselect填料生产的时候');
